...
: ${AMENT_CURRENT_PREFIX:="/workspaces/ros2/swerve_robot/install/swerve_robot_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/swerve_robot_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/swerve_robot_description/environment/path.sh"
